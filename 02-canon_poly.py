...
init_state_list = [
    [0, v * cos(a1 * 3.14 / 180), 0, v * sin(a1 * 3.14 / 180)],
...
balls = [ax.plot(res[0:1, 0], res[0:1, 2], "o", lw=1)[0] for res in res_list]
