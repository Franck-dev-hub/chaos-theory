...
def animate(i):
    ...
    ball1.set_data([t[j]], [x2[j]])
    ball2.set_data([t[j]], [y2[j]])
    ball3.set_data([t[j]], [z2[j]])
...
ani = animation.FuncAnimation(
    fig, animate, np.arange(0, NFRAMES), init_func=init, interval=33, blit=True
)
